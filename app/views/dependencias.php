...
$sentencia_select = $conect->prepare('SELECT *FROM dependencias ORDER BY id_dependencia ASC');
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="tablaDependencia" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Dependencia</th>
                                ...
                                <tbody>
                                    <?php foreach ($respuesta as $fila) : ?>
                                        <tr>
                                            <td><?php echo $fila['id_dependencia']; ?></td>
