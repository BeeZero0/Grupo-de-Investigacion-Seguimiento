...
$sentencia_select = $conect->prepare('SELECT *FROM reuniones_academicas ORDER BY id_reunion_academica ASC');
        ...
        <main>
            <div class="container-fluid">
                ...
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Reuniones Académicas</li>
                </ol>
                <div class="card mb-4">
                    <div class="card-header">
                        <i class="fas fa-table mr-1"></i>
                        Registros de Reuniones Académicas
                    </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="tablaReunionesAcademicas" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                ...
                                <tbody>
                                    <?php foreach ($respuesta as $fila) : ?>
                                        <tr>
                                            <td><?php echo $fila['id_reunion_academica']; ?></td>
                                            <td><?php echo $fila['nombre_reunion']; ?></td>
        ...
        <div class="modal fade" id="modalCRUD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form id="formReunionesAcademicas">
                        <div class="modal-body">
                        <div class="form-group">
                                <label for="nombre_reunion" class="col-form-label">Nombre de la Reunión</label>
                                <input type="text" class="form-control" name="nombre_reunion" id="nombre_reunion">
                            </div>
                            <div class="form-group">
...
<script src="../../js/reuniones_academicas.js"></script>
</body>
