...
$sentencia_select = $conect->prepare('SELECT *FROM objetivos ORDER BY id_objetivo ASC');
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="tablaObjetivos" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Nombre</th>
                                ...
                                <tbody>
                                    <?php foreach ($respuesta as $fila) : ?>
                                        <tr>
                                            <td><?php echo $fila['id_objetivo']; ?></td>
                ...
                <div class="modal-content">
                    ...
                    <form id="formObjetivos">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="objetivo" class="col-form-label">Descripción</label>
