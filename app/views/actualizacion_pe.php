...
$sentencia_select = $conect->prepare('SELECT *FROM actualizacion_pe ORDER BY id_actualizacion_pe ASC');
        ...
        <main>
            <div class="container-fluid">
                ...
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Actualización PE</li>
                </ol>
                <div class="card mb-4">
                    <div class="card-header">
                        <i class="fas fa-table mr-1"></i>
                        Registros de Actualización PE
                    </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="tablaActualizacionPE" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                ...
                                <tbody>
                                    <?php foreach ($respuesta as $fila) : ?>
                                        <tr>
                                            <td><?php echo $fila['id_actualizacion_pe']; ?></td>
...
<script src="../../js/actualizacion_pe.js"></script>
</body>
